...
const tr: Dict = {
  ...
  metaDesc:
    '2026 Dünya Kupası — fikstür, gruplar, eleme tablosu, takımlar, statlar, hava durumu ve TV kanalları 23 dilde. Resmî olmayan açık kaynak taraftar projesi.',
  // nav
  navHome: 'Ana sayfa',
  navMatches: 'Maçlar',
  navGroups: 'Gruplar',
  ...
  navGame: 'Mini oyun',
  gameTitle: 'Penaltı atışları mini oyunu',
  gameSub: 'Takımını seç ve dünyaya meydan oku: gerçek kadrolar, rastgele atıcılar.',
  gameYourTeam: 'Takımın',
  gameOpponent: 'Rakip',
  gameRandom: 'Rastgele takım',
  gameStart: 'Penaltıları başlat',
  gameShootHint: 'Şut atacağın yere dokun',
  gameSaveHint: 'Uzanacağın yere dokun',
  gameGoal: 'GOOOL!',
  gameSaved: 'KURTARDI!',
  gameMissed: 'DIŞARI!',
  gameYouSaved: 'MÜTHİŞ KURTARIŞ!',
  gameRound: '{n}. tur',
  gameSuddenDeath: 'Ani ölüm',
  gameYouWin: 'Penaltıları kazandın!',
  gameYouLose: 'Penaltıları kaybettin.',
