...
const nl: Dict = {
  ...
  metaDesc:
    'WK 2026 — speelschema, groepen, knock-outschema, teams, stadions, weer en tv-zenders in 23 talen. Onofficieel opensource-fanproject.',
  // nav
  navHome: 'Home',
  ...
  navGame: 'Minigame',
  gameTitle: 'Strafschoppen-minigame',
  gameSub: 'Kies je team en neem het op tegen de wereld: echte selecties, willekeurige nemers.',
  gameYourTeam: 'Jouw team',
  gameOpponent: 'Tegenstander',
  gameRandom: 'Willekeurig team',
  gameStart: 'Start penaltyserie',
  gameShootHint: 'Tik waar je wilt schieten',
  gameSaveHint: 'Tik waar je wilt duiken',
  gameGoal: 'GOAL!',
  gameSaved: 'GERED!',
  gameMissed: 'NAAST!',
  gameYouSaved: 'WAT EEN REDDING!',
  gameRound: 'Ronde {n}',
  gameSuddenDeath: 'Sudden death',
  gameYouWin: 'Jij wint de penaltyserie!',
  gameYouLose: 'Je verliest de penaltyserie.',
  gamePlayAgain: 'Opnieuw spelen',
  gameKicker: 'Nemer',
  gameKeeper: 'Keeper',
}
