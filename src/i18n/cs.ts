...
const cs: Dict = {
  ...
  metaDesc:
    'MS 2026 — rozpis, skupiny, pavouk, týmy, stadiony, počasí a TV kanály ve 23 jazycích. Neoficiální open source projekt fanoušků.',
  // nav
  navHome: 'Domů',
  navMatches: 'Zápasy',
  navGroups: 'Skupiny',
  ...
  navGame: 'Minihra',
  gameTitle: 'Minihra: penaltový rozstřel',
  gameSub: 'Vyber si tým a postav se světu: skutečné soupisky, náhodní exekutoři.',
  gameYourTeam: 'Tvůj tým',
  gameOpponent: 'Soupeř',
  gameRandom: 'Náhodný tým',
  gameStart: 'Zahájit rozstřel',
  gameShootHint: 'Klepni, kam vystřelíš',
  gameSaveHint: 'Klepni, kam skočíš',
  gameGoal: 'GÓL!',
  gameSaved: 'CHYCENO!',
  gameMissed: 'VEDLE!',
  gameYouSaved: 'PARÁDNÍ ZÁKROK!',
  gameRound: 'Série {n}',
  gameSuddenDeath: 'Náhlá smrt',
  gameYouWin: 'Vyhráváš rozstřel!',
  gameYouLose: 'Prohráváš rozstřel.',
  gamePlayAgain: 'Hrát znovu',
  gameKicker: 'Exekutor',
  gameKeeper: 'Brankář',
}
