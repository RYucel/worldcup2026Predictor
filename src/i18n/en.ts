...
const en: Dict = {
  ...
  navGame: 'Minigame',
  gameTitle: 'Penalty shootout minigame',
  gameSub: 'Pick your team and take on the world: real squads, random takers.',
  gameYourTeam: 'Your team',
  gameOpponent: 'Opponent',
  gameRandom: 'Random team',
  gameStart: 'Start shootout',
  gameShootHint: 'Tap where to shoot',
  gameSaveHint: 'Tap where to dive',
  gameGoal: 'GOAL!',
  gameSaved: 'SAVED!',
  gameMissed: 'OFF TARGET!',
  gameYouSaved: 'WHAT A SAVE!',
  gameRound: 'Round {n}',
  gameSuddenDeath: 'Sudden death',
  gameYouWin: 'You win the shootout!',
  gameYouLose: 'You lose the shootout.',
