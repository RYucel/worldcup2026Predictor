...
const uz: Dict = {
  ...
  metaDesc:
    '2026 Jahon chempionati — taqvim, guruhlar, pley-off shajarasi, jamoalar, stadionlar, ob-havo va TV kanallar 23 tilda. Norasmiy ochiq kodli muxlislar loyihasi.',
  // nav
  navHome: 'Bosh sahifa',
  navMatches: "O'yinlar",
  navGroups: 'Guruhlar',
  ...
  navGame: "Mini o'yin",
  gameTitle: "Penaltilar seriyasi mini o'yini",
  gameSub: "Jamoangizni tanlang va butun dunyoga qarshi o'ynang: haqiqiy tarkiblar, tasodifiy zarbachilar.",
  gameYourTeam: 'Sizning jamoangiz',
  gameOpponent: 'Raqib',
  gameRandom: 'Tasodifiy jamoa',
  gameStart: 'Seriyani boshlash',
  gameShootHint: "Zarba yo'nalishini bosing",
  gameSaveHint: "Sakrash yo'nalishini bosing",
  gameGoal: 'GOL!',
  gameSaved: 'QAYTARILDI!',
  gameMissed: "YONIDAN O'TDI!",
  gameYouSaved: 'QANDAY QUTQARUV!',
  gameRound: '{n}-raund',
  gameSuddenDeath: "To'satdan o'lim",
  gameYouWin: "Penaltilar seriyasida g'alaba qozondingiz!",
  gameYouLose: "Penaltilar seriyasida mag'lub bo'ldingiz.",
  gamePlayAgain: "Yana o'ynash",
  gameKicker: 'Zarbachi',
  gameKeeper: 'Darvozabon',
}
