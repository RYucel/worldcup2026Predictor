...
const de: Dict = {
  ...
  metaDesc:
    'WM 2026 — Spielplan, Gruppen, Turnierbaum, Teams, Stadien, Wetter und TV-Sender in 23 Sprachen. Inoffizielles Open-Source-Fanprojekt.',
  // nav
  navHome: 'Start',
  navMatches: 'Spiele',
  navGroups: 'Gruppen',
  ...
  navGame: 'Minispiel',
  gameTitle: 'Elfmeterschießen-Minispiel',
  gameSub: 'Wähl dein Team und fordere die Welt heraus: echte Kader, zufällige Schützen.',
  gameYourTeam: 'Dein Team',
  gameOpponent: 'Gegner',
  gameRandom: 'Zufälliges Team',
  gameStart: 'Elfmeterschießen starten',
  gameShootHint: 'Tippe, wohin du schießen willst',
  gameSaveHint: 'Tippe, wohin du hechten willst',
  gameGoal: 'TOR!',
  gameSaved: 'GEHALTEN!',
  gameMissed: 'DANEBEN!',
  gameYouSaved: 'WAS FÜR EINE PARADE!',
  gameRound: 'Runde {n}',
  gameSuddenDeath: 'Sudden Death',
  gameYouWin: 'Du gewinnst das Elfmeterschießen!',
  gameYouLose: 'Du verlierst das Elfmeterschießen.',
