...
const hr: Dict = {
  ...
  metaDesc:
    'SP 2026 — raspored, skupine, kostur, momčadi, stadioni, vrijeme i TV kanali na 23 jezika. Neslužbeni open source navijački projekt.',
  // nav
  navHome: 'Početna',
  navMatches: 'Utakmice',
  navGroups: 'Skupine',
  ...
  navGame: 'Mini-igra',
  gameTitle: 'Mini-igra: jedanaesterci',
  gameSub: 'Odaberi svoju momčad i izazovi svijet: stvarni sastavi, nasumični izvođači.',
  gameYourTeam: 'Tvoja momčad',
  gameOpponent: 'Protivnik',
  gameRandom: 'Nasumična momčad',
  gameStart: 'Započni raspucavanje',
  gameShootHint: 'Dodirni kamo želiš pucati',
  gameSaveHint: 'Dodirni kamo se želiš baciti',
  gameGoal: 'GOL!',
  gameSaved: 'OBRANA!',
  gameMissed: 'PROMAŠAJ!',
  gameYouSaved: 'KAKVA OBRANA!',
  gameRound: 'Serija {n}',
  gameSuddenDeath: 'Iznenadna smrt',
  gameYouWin: 'Pobjeda u raspucavanju!',
  gameYouLose: 'Poraz u raspucavanju.',
  gamePlayAgain: 'Igraj ponovno',
  gameKicker: 'Izvođač',
  gameKeeper: 'Vratar',
}
