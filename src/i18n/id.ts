...
const id: Dict = {
  ...
  metaDesc:
    'Piala Dunia 2026 — jadwal, grup, bagan, tim, stadion, cuaca, dan saluran TV dalam 23 bahasa. Proyek open source tidak resmi.',
  // nav
  navHome: 'Beranda',
  ...
  navGame: 'Minigame',
  gameTitle: 'Minigame adu penalti',
  gameSub: 'Pilih timmu dan lawan dunia: skuad asli, penendang acak.',
  gameYourTeam: 'Tim kamu',
  gameOpponent: 'Lawan',
  gameRandom: 'Tim acak',
  gameStart: 'Mulai adu penalti',
  gameShootHint: 'Ketuk arah tendangan',
  gameSaveHint: 'Ketuk arah tepisan',
  gameGoal: 'GOL!',
  gameSaved: 'DITEPIS!',
  gameMissed: 'MELESET!',
  gameYouSaved: 'PENYELAMATAN GEMILANG!',
  gameRound: 'Ronde {n}',
  gameSuddenDeath: 'Sudden death',
  gameYouWin: 'Kamu menang adu penalti!',
  gameYouLose: 'Kamu kalah adu penalti.',
  gamePlayAgain: 'Main lagi',
  gameKicker: 'Penendang',
  gameKeeper: 'Kiper',
}
